  ...
  return (
    <React.Fragment>
      ...
      >
        ...
        {locationSet && (
          <div>
            <Trans>calculator.prevalence.underreporting_factor</Trans>:{' '}
            {prevalanceRatio(
        ...
        {locationSet && (
          <div>
            <Trans>calculator.prevalence.delay_factor</Trans>:{' '}
            {calculateDelayFactor(data.casesIncreasingPercentage).toFixed(2)}
          </div>
        )}

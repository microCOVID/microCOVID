...
import { Interaction, RiskProfile, intimateDurationFloor } from 'data/data'
import 'components/calculator/ExplanationCard/CalculationBreakdown.scss'
...
export default function CalculationBreakdown(props: {
  points: number
  lowerBound: number
  upperBound: number
        ...
        <ol>
          ...
          <li>
            ...
            <Trans i18nKey="calculator.explanationcard.details_range_explanation">
              Lorem ipsum{' '}
              <a href="/paper/uncertainty-estimation">uncertainty link</a> dolor
              sic amet
            </Trans>
          </li>
        </ol>

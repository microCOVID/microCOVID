...
For source control, we draw on the following sources, four of which are new in this revision of our estimates:
...
Despite the _fabric_ often being highly rated for filtration, KN95 masks usually provide a loose fit, with visible gaps, not much better than a surgical mask ([O'Kelly et al.](https://www.medrxiv.org/content/10.1101/2020.08.17.20176735v1.full.pdf)). In our personal experience with earloop KN95s, we have not been able to get a firm/tight seal. We therefore would estimate their source control factor as being in roughly the same 1/4 ballpark as surgical masks (_not_ in the rated ballpark of 95% protection i.e. 1/20 reduction), but perhaps slightly higher due to improved fabric. To quantitatively estimate the amount of improvement, we use [Konda et al.](https://pubs.acs.org/doi/10.1021/acsnano.0c03252)'s data about fabric filtration from a surgical mask with gaps, versus an N95 with gaps, as letting through 0.68 as much aerosol (as 0.34/0.5), which implies a slightly-improved *1/6 factor for KN95s* as contrasted with the 1/4 factor for surgical masks. We note this is a fairly speculative estimate, as the data on KN95s is limited. We also use this estimate as the source control factor for an N95 mask that the wearer has NOT checked for a seal.

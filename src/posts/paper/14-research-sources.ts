...
**Protection to others:** We use two studies as the source of our data for protection to others, excluding [Davies et al.](https://www.researchgate.net/publication/258525804_Testing_the_Efficacy_of_Homemade_Masks_Would_They_Protect_in_an_Influenza_Pandemic) (the third we used in making our original estimate, and the most optimistic of the three) because it does not provide clear confidence intervals.

...
* If you want to keep the same overall budget but live with housemates, you can increase your personal budget while maintaining the same annual risk; each housemate's activites has a reduced impact on others' microCOVID budget. I.e. 
N housemates, before vaccination each person's allocation of microCOVIDs would have been (200 / (1 + 0.4N)). After everyone is vaccinated, this increases to (200 / (1 + 0.17*N)).

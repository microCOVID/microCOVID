...
Here, let’s lay out the relative risk of taking a grocery trip with different mask options:
...
<figure>
<img src=${image2} width="550", height="387"/>
</figure>
...
<figure>
<img src=${image3} width="267", height="275"/>
</figure>


Surgical masks are a step up from cloth masks, but they have limited relevance in a world where you can get an N95 instead.  Their main advantages are being extremely cheap, widely available, and offering a bit more protection for the wearer than cloth masks.  Consequently we’re not going to focus on them that much.
...
<figure>
<img src=${image5} width="296", height="329"/>
</figure>
...
It should be noted that some N95s come with an exhalation valve.  While this makes the mask easier to breathe through, it lets you expel air from your mouth without any filtration, which isn’t safe for the people around you.  However, you don’t need to throw these masks out; you can just tape over the exhalation valve (on the outside, so other people know) and then wear it like a normal N95, or just put a surgical mask over it.

<figure>
<img src=${image6} width="531", height="258"/>
</figure>

One final note -- KN95 and N95 masks work on a very different principle from cloth masks -- they have an electrostatic charge that attracts small airborne particles that pass through the mask.  Water destroys the electric charge, so getting the mask wet will make it stop working.  Separately, the mask will stop working effectively once too many particles have become caught in it.  Here’s a [cute video explainer](https://www.youtube.com/watch?v=eAdanPfQdCA).
...
<figure>
<img src=${image7} width="514", height="339"/>
</figure>
...
<figure>
<img src=${image8} width="527", height="265"/>
</figure>

<figure>
<img src=${image9} width="527", height="259"/>
</figure>
...
<figure>
<img src=${image10} width="243", height="243"/>
</figure>
...
<figure>
<img src=${image11} width="345", height="424"/>
</figure>

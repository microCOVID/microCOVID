...
1. **Ask them about their behavior in the last 10 days**
    ...
    *   **Note:** Modeling someone's activities for the last 10 days is only accurate when their risk score is relatively low. If they have done any higher risk activities (around 100x your weekly budget) in the lsat 21 days, you may want to include those in your modeling. You can read more about doing so in the [FAQ](./faq#whats-up-with-the-0-7-day--range-and-2-9-day-range-what-are-they-for-why-the-difference).

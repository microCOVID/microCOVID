...
*   _All sheets that start with “INTERNAL_” are for internal calculations. Edit at your own risk._
...
<table>
  ...
  <tr>
   <td>In a closed pod of 4/10/20 people (<strong>who do not go to work or socialize</strong>)
   </td>
   <td>A known person who only interacts with 4/10/20 people who only interact with each other. This means collectively one grocery/errand run a week. No other in-person socialization or contact with the outside world for the entire group; unless masked, outdoors, and beyond 20 feet.[^1] 
   </td>
  </tr>
  <tr>
   <td>Has 1/4/10 close contact (incl. roommates) who socializes but <strong>does not work</strong>.
<p>
No other work or socializing.
   </td>
  ...
  <tr>
   <td>Has 1 close contact (incl. roommates) who is an <strong>essential worker</strong>.
<p>
No other work or socializing.
   </td>
   <td>A known person who has one close contact (including roommates) who works directly with the public. The person themselves has gone one one grocery/errand run in the past week. 
   </td>
  </tr>
  <tr>
   <td>Goes to bars/parties regularly
   </td>
...
## Using _Custom People_ sheet to model more precisely
...
3. **Activities: **Enter any activities they have done in the last 10 days the same way you would [enter your own activities](#). When in doubt, err on the side of overestimating.
...
[See Custom Person Modeling FAQ →](#)
...
[See how you might model this person in the Custom People sheet →](https://docs.google.com/spreadsheets/d/1-IEwUHHC-V8yzA4R6cShxlev63Ykm0uK61GUL_IynmA/edit#gid=311635422&range=C9)
...
<p id="gdcalert14" ><span style="color: red; font-weight: bold">>>>>>  gd2md-html alert: inline image link here (to images/image4.png). Store image on your image server and adjust path/filename/extension if necessary. </span><br>(<a href="#">Back to top</a>)(<a href="#gdcalert15">Next alert</a>)<br><span style="color: red; font-weight: bold">>>>>> </span></p>


![alt_text](images/image4.png "image_tooltip")


_[INTERNAL NOTE: Update this image before publishing]_
...
*   Sam sees their chiropractor once a week for 15 minutes. We model this person as “average” rather than “front line” because we know they are taking really strong screening practices. We model them the “symptoms free now” since they are taking their temperature daily and all staff 
...
*   **Other podmates:** There are 2 other people in Sam’s pod who also work from home and aren’t socializing with anyone outside of the pod. Again, we’ll use a “1% risk adherent” profile for them so we’re overestimating.
...
[See how you might model this person in the Custom People sheet →](https://docs.google.com/spreadsheets/d/1-IEwUHHC-V8yzA4R6cShxlev63Ykm0uK61GUL_IynmA/edit#gid=311635422&range=C15)



<p id="gdcalert15" ><span style="color: red; font-weight: bold">>>>>>  gd2md-html alert: inline image link here (to images/image5.png). Store image on your image server and adjust path/filename/extension if necessary. </span><br>(<a href="#">Back to top</a>)(<a href="#gdcalert16">Next alert</a>)<br><span style="color: red; font-weight: bold">>>>>> </span></p>
...
## Have a question? Need support? Have feedback?

We welcome questions, feedback, and feature requests.

If you’re familiar with GitHub, please [open an issue there](https://github.com/microcovid/microcovid/issues/new).

If you’re not familiar with GitHub, you can email Jeremy Blanchard, our spreadsheet maintainer, at [blanchard.jeremy@gmail.com](mailto:blanchard.jeremy@gmail.com) or email the team .

...
So we know what to _avoid_—the 3 C’s. But besides staying in our homes, what should we _do_? We can choose to have “MOD” hangouts — 1-on-1 or small-group socializing that is Masked, Outdoors, and Distanced. These hangouts are MODified from normal. The COVID “smoke” gets stopped by your mask, falls to the ground before it reaches the other person, and dissipates into the air. MODified hangouts are much safer, especially when they don’t involve many people.


![alt_text](images/image2.png "image_tooltip")


In the section below, we’ll try to answer questions like: How much does a mask actually help? Is it safer to be indoors with a mask, or outdoors without one? Should you stay 6ft away or 10ft? 

In order to answer this question in terms of quantitative microCOVID numbers (not just “high” or “low” risk), we’ll now dive into the research.  Or, if you want to skip right to the calculator to start playing with numbers, click here (and feel free to jump back to this article for explanations). **(TODO link)**


### III.B) The cost of activities in microCOVIDs

In order to get the actual microCOVIDs of an activity, we need to combine two numbers:



*   _Activity Risk:_ The chance of this activity transmitting COVID to you, if the other person currently has COVID.
*   _Person Risk:_ The chance of the other person currently having COVID. This is based on overall prevalence in your area and their recent behaviors.
...
**In other words, whenever you’re deciding to do an activity, ask: How risky is the activity? And how risky are the other people you’re doing it with?**

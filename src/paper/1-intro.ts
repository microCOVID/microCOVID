...
**White paper:** _Catherine Olsson, Rhys Lindmark, Joshua Oreman, Stephanie Bachar, Sarah Dobro, Jacob Falkovich, Anna Tsykalova, Matt Bell_ [TODO add others who contributed prose]
...
## Disclaimer
_This article (and corresponding calculator) was collaboratively written by the members and friends of Ibasho, a communal house in San Francisco. Our goal is to protect our broader community’s physical and mental health during the pandemic, by promoting balanced evidence-based decision-making by individual members. We have based our numbers in this article on scientific research; however, none of us are epidemiologists and our model is still a guess and not an authoritative “truth”. Please continue to follow government guidance._
...
Footnotes[^demo] usually contain nerdy details for detail-loving readers, and often a link to *even more gory detail* in the TResearch Sources section [TODO link].

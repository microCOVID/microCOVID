...
You’re planning to hang out with Rosie and want to know her "Person Risk" score, so you can know what precautions to take. You calculate:
...
*   Advanced method: **217** Person Risk
    ...
    *   Each walk starts with a 6% Activity Risk (for one-time contact per hour) times 1.5 hours, and then gets a decrease of 2x for Rosie’s mask, 4x for her friend’s mask, and 20x for being outdoors. Since you she at regular distance on these walks (3 feet), there is no additional reduction for distance. We’ll treat the friends as average residents (using the 5107 risk number from above). Five walks in the past ten days adds up to \`0.06/hr ⨉ 1.5hr ⨉ 5 ⨉ 5106 ⨉ (1/2) ⨉ (1/4) ⨉ (1/20) = 14\` microCOVIDs.

...
export const RiskProfile: { [key: string]: FormValue } = {
  ...
  contact1: {
    label: 'Has 1 close contact (incl. roommates) who socializes but does not work. No other work or socializing.',
    multiplier: 0.3*0.5 + 0.0075, // Housemate + grocery exposure
  },

  contact4: {
    label: 'Has 4 close contacts (incl. roommates) who socialize but do not work. No other work or socializing.',
    multiplier: 4*0.3*0.5 + 0.0075, // Housemate + grocery exposure
  },

  contact10: {
    label: 'Has 10 close contacts (incl. roommates) who socialize but do not work. No other work or socializing.',
    multiplier: 10*0.3*0.5 + 0.0075, // Housemate + grocery exposure
  },

  contactWorks: {
    label: 'Has 1 close contact (incl. roommates) who is an essential worker. No other work or socializing.',
